...
[^2]: Although still the lestest version, it is from 2019. You may need to search their Github for the latest version [here](https://github.com/Minerx117/TTMiner/releases/tag/v2.2.5).
